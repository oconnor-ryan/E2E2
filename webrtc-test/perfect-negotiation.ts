 ...
 */
export function negotiateP2PConnection(isPolite: boolean, signalServer: SignalingServerMessageHandler, remoteVideo: HTMLVideoElement, ...mediaTracks: MediaStreamTrack[]) {
