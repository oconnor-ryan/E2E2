...
CREATE TABLE public.chat_member (
    ...
    pub_enc_key_base64 character varying NOT NULL
);
...
--
-- Name: sender_key_v1; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sender_key_v1 (
    sender_acct_id character varying(30) NOT NULL,
    receiver_acct_id character varying(30) NOT NULL,
    chat_id integer NOT NULL,
    key_enc_base64 character varying NOT NULL
);
...
--
-- Name: sender_key_v1 sender_key_receiver_acct_id_chat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sender_key_v1
    ADD CONSTRAINT sender_key_receiver_acct_id_chat_id_fkey FOREIGN KEY (receiver_acct_id, chat_id) REFERENCES public.chat_member(acct_id, chat_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: sender_key_v1 sender_key_sender_acct_id_chat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sender_key_v1
    ADD CONSTRAINT sender_key_sender_acct_id_chat_id_fkey FOREIGN KEY (sender_acct_id, chat_id) REFERENCES public.chat_member(acct_id, chat_id) ON UPDATE CASCADE ON DELETE CASCADE;
